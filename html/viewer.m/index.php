...
<head>
	<link href="../css/viewer-m.css" rel="stylesheet" type="text/css" />
	...
	<script>
		...
		function filter(){
			...
			var queryString = '?Sex=' + id.Iv.value + '&Hair=' + id.Szor.value + '&Size=' + id.Mar.value + '&IvD=' + id.IvD.value + '&Stat=' + id.Stat.value + '&Lang=<?php print $Lang;?>';
...
<body>
    ...
    <div id="GuestHeader">
        <div id="left">
            <a href="javascript:SetLang('HU');"><img src="../images/zaszlo_magyar.gif" height="100" title="Magyar" border="0" /></a> 
            <a href="javascript:SetLang('DE');"><img src="../images/zaszlo_nemet.gif" height="100" title="Deutsche" border="0" /></a> 
            <a href="javascript:SetLang('EN');"><img src="../images/zaszlo_angol.gif" height="100" title="English" border="0" /></a>
    ...
    <div id="GuestPage">
    	...
    	<form name="FiltForm">
            <table width="990" class="filter">
            	<tr>
                	<td width="450"><b><?php print DataName('G02',$Lang);?>: </b></td>
                    <td width="550"><b><?php print DataName('G03',$Lang);?>: </b></td>
               ...
               <tr>
               		<td width="450"><b><?php print DataName('SZ0',$Lang);?>: </b></td>
                    <td width="550"><b><?php print DataName('G24',$Lang);?>: </b></td>
               </tr>
               <tr>
               ...
               <tr>
                  <td width="200" colspan="2"><b><?php print DataName('G11',$Lang);?>: </b></td>
                  <td></td>
               <tr>
               		<td colspan="2"><select id="Stat" onchange="javascript:filter();" class="textfield">
                     <option value=""><?php print DataName('ALL',$Lang);?></option>
