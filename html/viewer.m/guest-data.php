...
<div id=\"Kep\" class=\"floatl border mh8\" style=\"display:none\">
	...
	<div class=\"fejl center\">
		<table width=\"1000px\" class=\"floatc\">
			<tr>
				<td width=\"70\"><a href=\"javascript:Next('$y')\"><img src=\"../images/br_prev.png\" width=\"48\" height=\"48\" title=\"Előző\" border=\'0\"></a></td>
				<td><h1>".DataName('G19',$Lang)."</h1>
				<p>".DataName('G20',$Lang).": ".$sorsz." db</p></td>
				<td width=\"70\"><a href=\"javascript:Next('$x')\"><img src=\"../images/br_next.png\" width=\"48\" height=\"48\" title=\"Következő\" border=\'0\"></a></td>
			</tr>
		</table>
	</div>
		<div>
		<table class=\"border floatc adatlap\" id=\"adatlap\"  width=\"1000px\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
		";
				...
				print"
				<tr height=\"33\">
    				<td colspan=\"2\" rowspan=\"7\" class=\"center\"><a href=\"javascript:popup('Kep')\"><img title='Megnyit' src=\"../pictures/".$dog[$i]['DOG_ID'].".jpg\" height=\"300\" border=\'0\"></a></td>
    				<td class=\"right\"><b>".DataName('G10',$Lang).":</b></td>
    				<td class=\"pl\" colspan=\"2\">".$dog[$i]['DOG_ID']."</td>
  				</tr>";
			}
		...
		print"</td>
		  ...
		  <tr height=\"33\">
				...
				<td width=\"130\"class=\"right\"><b>".DataName('G24',$Lang).":</b></td>
				<td width=\"340\" class=\"pl\">";
				if($dog[$i]['IV'] == '0'){
					print "<input type='checkbox' disabled='disabled' />";
				}
				else{
					print "<input type='checkbox' checked disabled='disabled' />";
				}
				print"</td>
		  </tr>
		  <tr height=\"33\">
		  ...
		  print"
		  		<a href=\"guest-print.php?ID=".$dog[$i]['DOG_ID']."\" target=\"_new\"><img title='Adatlap nyomtatása' src=\"../images/print.png\" width=\"48\" height=\"48\" border=\"0\"></a>
		  </td>
		  </tr>
		</table>
		</div></div>";
