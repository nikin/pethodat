...
print "<table cellpadding='0' cellspacing='0' border='0' id='ddog' width='100%'>
			<thead>
			...
			<tbody align='center'>";
$Aqry="SELECT DOG_ID, DOG_NAME, SEX, HAIR, COLOUR, B_DATE, BEF_PLACE, BEF_DATE, D_DATE FROM archive_dogs WHERE STATUS = 'ST5'";
