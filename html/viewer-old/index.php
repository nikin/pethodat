	...
	<div id="guest">
   	...
   	<div id="GuestLeft">
    	<form name="FiltForm">
            ...
            <table width="250">
            	<tr>
                	<td width="100"><b><?php print DataName('G02',$Lang);?>: </b></td>
            ...
            <tr>
                	<td width="100"><b><?php print DataName('G03',$Lang);?>: </b></td>
               ...
               <tr>
                	<td width="100"><b><?php print DataName('SZ0',$Lang);?>: </b></td>
               ...
               <tr>
                	<td width="100"><b><?php print DataName('G24',$Lang);?>: </b></td>
               ...
               <tr>
                	<td width="100"><b><?php print DataName('G11',$Lang);?>: </b></td>
